    ...
    <div class="container" style="background-color: #d1ebef">
        <div style="padding:20px">
            <form action="/profile/{{ $user->id }}" enctype="multipart/form-data" method="post">
                ...
                <div>
                    <h1 class="text-md-center pb-3" style="border-bottom: 1px solid rgba(0, 0, 0, 0.1)">Edit your profile</h1>
                </div>


                <div class="form-group row">
                    <label for="bio" class="col-md-4 col-form-label text-md-right"><b>{{ __('Biography') }}</b></label>
                ...
                <div class="form-group row">
                    <label for="profile_pic" class="col-md-4 col-form-label text-md-right"><b>{{ __('Profile picture') }}</b></label>
